var experimentController = (function() {
	...
	function resetSolvedButton() {
		if ($('#taskSolvedButton')[0].value != 'Weiter') $('#taskSolvedButton')[0].value = 'Weiter';
	}
	...
	function onEntityMarked(applicationEvent) {
		...
		events.log.controller.publish({
			text: 'experimentController',
			var1: currentStep.number,
			var2: taskState.missingMarks,
			var3: taskState.falseMarks,
			var4: entity.qualifiedName
		});
	}
